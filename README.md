...
- The strategy performs better on the Nasdaq, I hypothesise: the performance is better due to tech stocks having traits conducive to investors over estimating future volatility, therefore short volatility stratergies are effective. These traits of tech stocks include having high valuation multiples, low return on invested capital and an especially important idea of concentration risk amongst the 100 stocks in the index
